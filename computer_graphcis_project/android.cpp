...
//	또한 관절의 제한범위를 생각하여 fabs() 함수를 통해 관절의 움직임을 제한하였다.
//	*/
...
//	R_Arm_y = -fabs(sin(time) * 60 + 50);  //우측팔뚝 각도조절(fabs절대값을 줌으로써 팔뚝이 뒤로꺾이지 않는 한계점을 설정) 
//	L_Arm_y = -fabs(-sin(time) * 60 + 50); //좌측팔뚝 각도조절(fabs절대값을 줌으로써 팔뚝이 뒤로꺾이지 않는 한계점을 설정) 
//
//	R_Leg_y = fabs(-sin(time) * 30 - 30);  //우측종아리 각도조절(fabs절대값을 줌으로써 종아리가 앞으로 꺾이지 않는 한계점을 설정)
//	L_Leg_y = fabs(sin(time) * 30 - 30);   //좌측종아리 각도조절(fabs절대값을 줌으로써 종아리가 앞으로 꺾이지 않는 한계점을 설정)
...
//	glRotatef(fabs(sin(time) * 16), 1, 0, 0);//x축으로 16도 까지 각도틀어짐(fabs절대값을 줌으로써 몸체가 뒤로 꺾이지 않는 한계점을 설정)
...
//
//	R_Leg_y = fabs(-sin(time) * 30 - 20);  //우측종아리 각도조절(fabs절대값을 줌으로써 종아리가 앞으로 꺾이지 않는 한계점을 설정)
//	L_Leg_y = fabs(sin(time) * 30 - 20);   //좌측종아리 각도조절(fabs절대값을 줌으로써 종아리가 앞으로 꺾이지 않는 한계점을 설정)
...
//	*/
//	glRotatef(-fabs(sin(time) * 8), 1, 0, 0); //x축으로 8도 까지 각도틀어짐(fabs절대값을 줌으로써 몸체가 뒤로 꺾이지 않는 한계점을 설정)
