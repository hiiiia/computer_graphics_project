    ...
    bool Load(const char* path)
    {
        ...
        while (std::getline(file, line)) {
            ...
            if (tokens[0] == "o") {
                ...
                if (values1.size() == 2) {
                    objInfo.faces_vertices.push_back(ivec3(values1[0] - 1, values2[0] - 1, values3[0] - 1 ));
                    objInfo.faces_normals.push_back(ivec3(values1[1] - 1, values2[1] - 1, values3[1] - 1 ));
                }

                if (values1.size() == 3) {
                    objInfo.faces_vertices.push_back(ivec3(values1[0] - 1, values2[0] - 1, values3[0] - 1 ));
                    objInfo.faces_uvs.push_back(ivec3(values1[1] - 1, values2[1] - 1, values3[1] - 1 ));
                    objInfo.faces_normals.push_back(ivec3(values1[2] - 1, values2[2] - 1, values3[2] - 1));
